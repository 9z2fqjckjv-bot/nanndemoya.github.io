(function () {
  ...
  overlay.innerHTML = `
    <div class="nanndemoya-consent-modal" role="dialog" aria-modal="true" aria-labelledby="nanndemoya-consent-title">
      ...
      <p>Googleの利用規約とプライバシーポリシーはこちら（<a href="https://policies.google.com/" target="_blank" rel="noopener noreferrer">こちら</a>）。</p>
      <p>「何でも屋」の利用規約とプライバシーポリシーはこちら（<a href="policy.html">こちら</a>）。</p>

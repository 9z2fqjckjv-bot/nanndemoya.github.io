(() => {
  const searchPages = [
    ...
    { title: 'パートナー案内', path: 'partner_root.html' },
    ...
    { title: '新体力テスト器具購入基金', path: 'guide/N.C.F~Nanndemoya_Crowd_Funding/New_Stamina_tests.html' },
    ...
    { title: 'パートナーについて', path: 'guide/partner/info.html' },
    { title: 'パートナー契約', path: 'guide/partner/rule.html' },
    { title: 'パートナーライセンス', path: 'guide/partner/license.html' },
    { title: 'パートナー資格の認定処理', path: 'guide/partner/pcp.html' },
    { title: 'パートナーコンテンツ', path: 'guide/partner/contents.html' },
    { title: 'お仕事体験', path: 'guide/partner/kids.html' },
    { title: 'お仕事体験 実績一覧', path: 'guide/partner/kids-award.html' },
    { title: 'お仕事体験の特典', path: 'guide/partner/kids-money.html' },
    { title: 'お手伝い', path: 'guide/partner/junior.html' },
    { title: 'お手伝い特典ショップ', path: 'guide/partner/junior-awerd.html' },
    { title: '学校の認可', path: 'guide/partner/student.html' },
